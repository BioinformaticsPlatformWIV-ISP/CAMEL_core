...
from camelcore.app.reports.htmlbase import HtmlBase
from camelcore.app.reports.htmlelement import HtmlElement
from pathlib import Path

from camelcore.resources import LOGO_SCIENSANO
    ...
    def add_pipeline_header(self, pipeline_name: str) -> None:
        ...
        with self.get_tag('div', [('class', 'header')]):
            with self.get_tag('div', [('id', 'header_title')]):
                self._doc.stag('img', src=LOGO_SCIENSANO.name, alt='Sciensano Belgium', id='header_logo', height=80)
